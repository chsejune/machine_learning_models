...
model_save_path = "results/SA_pretraining_model_"+time_stamp+"_epoch{epoch:04d}_trainingL_{loss:.5f}.hdf5" # 저장할 파일 이름 설정 (time stamp 이용)
...
model.fit(trainX, trainY, epochs=20, verbose=2, validation_data=(testX, testY), callbacks=[checkpoint])
